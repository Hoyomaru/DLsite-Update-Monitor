...
Download the validated Playnite extension package:

- [`DLsiteUpdateMonitor 0.1.0 (.pext)`](dist/DLsiteUpdateMonitor_334542c6-1f81-4cc5-afd5-e052b021d37e_0_1_0.pext)

Then double-click the `.pext` file or install it through Playnite.
